...
int main()
{
    // Get number of threads this hardware can support
    unsigned int n = std::thread::hardware_concurrency();
    std::cout << n << " concurrent threads are supported.\n";
    
    // Get time before code starts executing
    int startTime = clock(); std::cout << "Clock Start: " << startTime  << std::endl;
    
    FindPrimesWithThreads(1, 112, 4);
    
    // Get time after execution
    int endTime = clock(); std::cout << "Clock End: " << endTime  << std::endl;
